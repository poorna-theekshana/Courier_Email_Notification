...
// Define the message content based on the event 
$data = 'data';

//convert data array into data object.
$data = (object) ['data' => $data];

try {
    $response = $mail->sendNotification($notificationId, $recipient, null, $profileObject, $dataObject, $emailData); // send the email using Courier for the required Notification.
    echo 'Email Sent';
} catch (Exception $e) {
